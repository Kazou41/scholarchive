...
<section class="dk-page">
    ...
    <div class="container" style="max-width:700px;position:relative;z-index:1;">
        ...
        {{-- Page Title --}}
        <div class="dk-card animate-item delay-2" style="margin-bottom:1.5rem;">
            <div style="display:flex;align-items:center;gap:1rem;">
                <div class="dk-settings-icon">
                ...
                <div>
                    <h2 class="dk-card-title" style="margin-bottom:0.25rem;">Pengaturan Akun</h2>
                    <p style="color:#94a3b8;font-size:0.875rem;margin:0;">Kelola email dan password akun Anda</p>
                </div>
            </div>
        </div>
