...
@php $isDark = request()->routeIs('home') || request()->routeIs('help') || request()->routeIs('portfolio.*') || request()->routeIs('student.portfolio.*') || request()->routeIs('student.generate-cv') || request()->routeIs('student.public-profile') || request()->routeIs('student.profile') || request()->routeIs('student.profile.edit') || request()->routeIs('student.settings'); @endphp
